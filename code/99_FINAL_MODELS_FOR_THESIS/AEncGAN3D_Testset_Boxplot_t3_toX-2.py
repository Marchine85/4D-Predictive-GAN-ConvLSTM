...
errors_t20_inc1_t3 = np.loadtxt(os.path.join(base_dir, "evals\AEncGAN3D_TestSet_Errors_T20_TINC1_t3_toX-2.txt"), delimiter=",", skiprows=1)
errors_t40_inc2_t3 = np.loadtxt(os.path.join(base_dir, "evals\AEncGAN3D_TestSet_Errors_T40_TINC2_t3_toX-2.txt"), delimiter=",", skiprows=1)
errors_t80_inc4_t3 = np.loadtxt(os.path.join(base_dir, "evals\AEncGAN3D_TestSet_Errors_T80_TINC4_t3_toX-2.txt"), delimiter=",", skiprows=1)
...
fig.legend([bplot1["boxes"][0], bplot1["boxes"][1], bplot1["boxes"][2], bplot1["means"][0]], ["Prediction(~xt1) vs Target(xt1)", "Prediction(~xt1) vs Input(xt-2)", "Target(xt1) vs Input(xt-2) - Null Model", "Means"], loc='lower center', ncols=4, bbox_to_anchor=(0.5, -0.04), bbox_transform=fig.transFigure)


plt.savefig(os.path.join(base_dir,"plots/AEncGAN3D_MSEJaccard_Errors_Boxplot_t3_toX-2.png"), bbox_inches="tight")