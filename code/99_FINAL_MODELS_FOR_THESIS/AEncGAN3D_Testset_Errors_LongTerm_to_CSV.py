...
np.savetxt(f"evals/AEncGAN3D_TestSet_Errors_LongTerm_T{T}_TINC{TINC}.txt" , LOSSES, fmt="%20.5f, %20.5f, %20.5f, %20.5f, %20.5f, %20.5f, %20.5f, %20.5f, %20.5f, %20.5f, %20.5f, %20.5f, %20.5f, %20.5f, %20.5f, %20.5f, %20.5f, %20.5f, %20.5f, %20.5f, %20.5f, %20.5f, %20.5f, %20.5f, %20.5f, %20.5f, %20.5f, %20.5f, %20.5f, %20.5f", delimiter=',', header=header)
