...
errors_t20_inc1 = np.loadtxt(os.path.join(base_dir, "evals\AEncGAN3D_TestSet_Errors_T20_TINC1.txt"), delimiter=",", skiprows=1)
errors_t40_inc2 = np.loadtxt(os.path.join(base_dir, "evals\AEncGAN3D_TestSet_Errors_T40_TINC2.txt"), delimiter=",", skiprows=1)
errors_t80_inc4 = np.loadtxt(os.path.join(base_dir, "evals\AEncGAN3D_TestSet_Errors_T80_TINC4.txt"), delimiter=",", skiprows=1)
...
fig.legend([bplot1["boxes"][0], bplot1["boxes"][1], bplot1["boxes"][2], bplot1["means"][0]], ["Prediction vs Target(xt1)", "Prediction vs Input(xt0)", "Null Model (xt1 vs xt0)", "Mean"], loc='lower center', ncols=4, bbox_to_anchor=(0.5, -0.04), bbox_transform=fig.transFigure)
...
plt.savefig(os.path.join(base_dir,"plots/AEncGAN3D_MSEJaccard_Errors_Histogram_Boxplot.png"), bbox_inches="tight")