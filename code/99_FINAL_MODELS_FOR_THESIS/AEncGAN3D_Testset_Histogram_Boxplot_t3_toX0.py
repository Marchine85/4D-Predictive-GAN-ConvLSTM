...
errors_t20_inc1 = np.loadtxt(os.path.join(base_dir, "evals\AEncGAN3D_TestSet_Errors_T20_TINC1_t3_toX0.txt"), delimiter=",", skiprows=1)
errors_t40_inc2 = np.loadtxt(os.path.join(base_dir, "evals\AEncGAN3D_TestSet_Errors_T40_TINC2_t3_toX0.txt"), delimiter=",", skiprows=1)
errors_t80_inc4 = np.loadtxt(os.path.join(base_dir, "evals\AEncGAN3D_TestSet_Errors_T80_TINC4_t3_toX0.txt"), delimiter=",", skiprows=1)
...
fig.legend([bplot1["boxes"][0], bplot1["boxes"][1], bplot1["boxes"][2], bplot1["means"][0]], ["Prediction(~xt1) vs Target(xt1)", "Prediction(~xt1) vs Input(xt0)", "Target(xt1) vs Input(xt0) - Null Model", "Mean"], loc='lower center', ncols=4, bbox_to_anchor=(0.5, -0.04), bbox_transform=fig.transFigure)
...
plt.savefig(os.path.join(base_dir,"plots/AEncGAN3D_MSEJaccard_Errors_Histogram_Boxplot_t3_toX0.png"), bbox_inches="tight")