...
errors_t20_inc1_t3_toX1 = np.loadtxt(os.path.join(base_dir, "evals\AEncGAN3D_TestSet_Errors_T20_TINC1_t3_toX-1.txt"), delimiter=",", skiprows=1)
errors_t40_inc2_t3_toX1 = np.loadtxt(os.path.join(base_dir, "evals\AEncGAN3D_TestSet_Errors_T40_TINC2_t3_toX-1.txt"), delimiter=",", skiprows=1)
errors_t80_inc4_t3_toX1 = np.loadtxt(os.path.join(base_dir, "evals\AEncGAN3D_TestSet_Errors_T80_TINC4_t3_toX-1.txt"), delimiter=",", skiprows=1)

###############################################################################
# PLOT MSE ERRORS
###############################################################################
mse_t20_inc1 = errors_t20_inc1_t3_toX1[:,0]
mse_t20_inc1_mean = np.round(np.mean(mse_t20_inc1),4)
mse_t20_inc1_stddev = np.round(np.std(mse_t20_inc1),4)
mse_null_t20_inc1 = errors_t20_inc1_t3_toX1[:,1]
mse_null_t20_inc1_mean = np.round(np.mean(mse_null_t20_inc1),4)
mse_null_t20_inc1_stddev = np.round(np.std(mse_null_t20_inc1),4)
mse_input_t20_inc1 = errors_t20_inc1_t3_toX1[:,2]
...
jaccard_input_t20_inc1 = errors_t20_inc1_t3_toX1[:,5]
...
jaccard_input_t40_inc2 = errors_t40_inc2_t3_toX1[:,5]
...
jaccard_input_t80_inc4 = errors_t80_inc4_t3_toX1[:,5]
...
fig.legend(["Prediction(~xt1) vs Target(xt1)", "Prediction(~xt1) vs Input(xt-1)", "Target(xt1) vs Input(xt-1) - Null Model"], loc='lower center', ncols=3, bbox_to_anchor=(0.5, -0.04), bbox_transform=fig.transFigure)


plt.savefig(os.path.join(base_dir,"plots/AEncGAN3D_MSEJaccard_Errors_Histogram_t3_toX-1.png"), bbox_inches="tight")