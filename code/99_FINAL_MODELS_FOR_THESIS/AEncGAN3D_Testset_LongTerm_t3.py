...
longterm_t20_inc1 = np.loadtxt(os.path.join(base_dir, "evals\AEncGAN3D_TestSet_Errors_LongTerm_T20_TINC1_t3.txt"), delimiter=",", skiprows=1)
longterm_t40_inc2 = np.loadtxt(os.path.join(base_dir, "evals\AEncGAN3D_TestSet_Errors_LongTerm_T40_TINC2_t3.txt"), delimiter=",", skiprows=1)
longterm_t80_inc4 = np.loadtxt(os.path.join(base_dir, "evals\AEncGAN3D_TestSet_Errors_LongTerm_T80_TINC4_t3.txt"), delimiter=",", skiprows=1)
...
plt.savefig(os.path.join(base_dir,"plots/AEncGAN3D_LongTerm_MSEJaccard_Errors_t3.png"), bbox_inches="tight")