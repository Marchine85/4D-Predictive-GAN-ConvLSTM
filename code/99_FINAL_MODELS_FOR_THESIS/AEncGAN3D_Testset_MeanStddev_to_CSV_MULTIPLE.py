...
errors_t20_inc1_t3 = np.loadtxt(os.path.join(base_dir, "evals\AEncGAN3D_TestSet_Errors_T20_TINC1_t3_toX0.txt"), delimiter=",", skiprows=1)
errors_t40_inc2_t3 = np.loadtxt(os.path.join(base_dir, "evals\AEncGAN3D_TestSet_Errors_T40_TINC2_t3_toX0.txt"), delimiter=",", skiprows=1)
errors_t80_inc4_t3 = np.loadtxt(os.path.join(base_dir, "evals\AEncGAN3D_TestSet_Errors_T80_TINC4_t3_toX0.txt"), delimiter=",", skiprows=1)
...
np.savetxt(f"evals/AEncGAN3D_TestSet_MeanStddev_Multiple.txt" , all_results, fmt="%20s", delimiter=',', header=header)
