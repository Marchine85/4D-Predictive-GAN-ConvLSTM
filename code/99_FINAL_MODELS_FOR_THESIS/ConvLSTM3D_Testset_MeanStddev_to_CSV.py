...
errors_t20_inc1_t3 = np.loadtxt(os.path.join(base_dir, "evals\ConvLSTM3D_TestSet_Errors_T20_TINC1.txt"), delimiter=",", skiprows=1)
errors_t40_inc2_t3 = np.loadtxt(os.path.join(base_dir, "evals\ConvLSTM3D_TestSet_Errors_T40_TINC2.txt"), delimiter=",", skiprows=1)
errors_t80_inc4_t3 = np.loadtxt(os.path.join(base_dir, "evals\ConvLSTM3D_TestSet_Errors_T80_TINC4.txt"), delimiter=",", skiprows=1)
...
np.savetxt(f"evals/ConvLSTM3D_TestSet_MeanStddev.txt" , all_results, fmt="%20s", delimiter=',', header=header)
